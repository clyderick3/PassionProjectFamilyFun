...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAMILYTREE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FAMILYTREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FAMILYTREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FAMILYTREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FAMILYTREE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FAMILYTREE actions', async () => {
      const expectedActions = [
        {
