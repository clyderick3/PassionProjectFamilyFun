...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOURNALING_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOURNALING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOURNALING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOURNALING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOURNALING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOURNALING actions', async () => {
      const expectedActions = [
        {
