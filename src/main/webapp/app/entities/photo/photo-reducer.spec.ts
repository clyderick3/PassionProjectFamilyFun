...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './photo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHOTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHOTO actions', async () => {
      const expectedActions = [
        {
