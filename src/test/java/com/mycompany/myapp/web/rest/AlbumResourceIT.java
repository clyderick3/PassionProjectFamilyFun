...
class AlbumResourceIT {
    ...
    public static Album createEntity(EntityManager em) {
        Album album = new Album().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
        return album;
    }
    ...
    public static Album createUpdatedEntity(EntityManager em) {
        Album album = new Album().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
        return album;
    }
    ...
    void putNewAlbum() throws Exception {
        ...
        updatedAlbum.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateAlbumWithPatch() throws Exception {
        ...
        partialUpdatedAlbum.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
